...
(function (root, factory) {
  ...
  const PERMISSIONS = {
    ...
    changePrices: "Change Product Prices & Discount %",
    billDiscount: "Give Bill Discount % at Checkout",
  ...
  const ROLE_DEFAULTS = {
    ...
    Manager: [
      ...
      "changePrices", "billDiscount", "stockAdjust", "editSales", "cancelSales"
    ],
    Cashier: ["dashboard", "pos", "sales", "customers", "attendance", "expenses", "billDiscount"]
  };
  ...
  const LEGACY_MAP = {
    dashboard: ["dashboard"],
    billing: ["pos", "customers", "billDiscount"],
